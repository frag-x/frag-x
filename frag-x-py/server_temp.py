...
from converters import convert_player_data_to_str, convert_str_to_player_data_server, convert_pos_str_to_player_pos, convert_player_pos_to_pos_str
        ...
        try: 
            ...
            if not data:
                ...
                for player_data in messages[:-1]:
                    ...
                    player_id, x, y, delta_time = convert_str_to_player_data_server(player_data)
                    print(player_id, x,y,delta_time)

                    q_drain_lock.acquire()

                    state_queue.put((player_id, x, y, delta_time))
...
while True:
    ...
    while not state_queue.empty():
        ...
        player_id, x, y, delta_time = state_queue.get()
    ...
    for p in id_to_player.values():
        server_updates.append(p.get_sendable_position_state())

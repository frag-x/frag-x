...
function love.draw()
  ...
  -- Draw aim line
  love.graphics.line(player.body:getX(), player.body:getY(), player.body:getX() + math.cos(rotationAngle) * aimLength , player.body:getY()+ math.sin(rotationAngle) * aimLength)

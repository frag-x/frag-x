...
class ChatBox:
    ...
    After a certian amount of time messages fade away and are removed from the chat
    """
    ...
    def add_message(self, message: str) -> None:
        ...
        self.curr_height += message.get_height()
        self.messages.append(message)
        self.message_to_time[message] = 0
    ...
    def update_message_times(self, time_since_last_frame: float) -> None:
        for k, v in self.message_to_time.items():
            self.message_to_time[k] = v + time_since_last_frame


class MultiLineSurface:
    ...
    def construct_surface(self):
        ...
        for line in final_lines:
            ...
            if self.justification == 0:
                ...
                surface.blit(
                    temp_surface,
                    ((self.rect.width - temp_surface.get_width()) / 2, accumulated_height),
                )
